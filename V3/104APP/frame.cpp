...
bool Frame::SetReadConfirm(unsigned char *FileID, unsigned char *FileOffset, unsigned char desc)
{
    /*
        68 18 00 00 00 00
        d2 00 05 00 01 00
    ...
    */
    ...
    ASDU[index] = 0x02;
    ASDU[index+1] = 0x06;
    my_strncpy(ASDU+index+2,FileID,4);
    my_strncpy(ASDU+index+6,FileOffset,4);
    ASDU[index+10] = desc;
