...
#define M_ME_TE_1 30    //带 CP56Time2a 时标的单点信息
#define M_ME_TF_1 31    //带 CP56Time2a 时标的双点信息
#define M_ME_NA_1 9     //测量值，归一化值
#define M_ME_NB_1 11    // 测量值，标度化值
#define M_ME_NC_1 13    //测量值，短浮点数
#define M_FT_NA_1 42    //故障值信息
#define M_IT_NB_1 206   //累计量，短浮点数
#define M_IT_TC_1 207   //带 CP56Time2a 时标的累计量，短浮点数
//--------------------------
